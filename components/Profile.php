...
class Profile extends ComponentBase
{
    ...
    public function onProfileUpdate() {
            ...
            $messages = [
                'first_name.required' => trans('axenso.sso::lang.messages.validation.required.name'),
                'last_name.required' => trans('axenso.sso::lang.messages.validation.required.lastname'),
                'password.required' => trans('axenso.sso::lang.messages.register.passwordrequired'),
                'password.confirmed' => trans('axenso.sso::lang.messages.validation.confirmed.password'),
                'profession.required' => trans('axenso.sso::lang.messages.validation.required.profession'),
                'specialization.required' => trans('axenso.sso::lang.messages.validation.required.specialization'),
                'board_number.required' => trans('axenso.sso::lang.messages.validation.required.board_number'),
