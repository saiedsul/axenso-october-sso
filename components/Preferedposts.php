...
class Preferedposts extends ComponentBase
{
    /**
    ...
    {
        return [
            'name'        => 'Prefered Post list',
            'description' => 'Show post list as user prefrences'
        ];
    }
    ...
    protected function listPosts()
    {
        ...
        if ($user && $user->preferences != null) {
         $prefrences = explode(',',$user->preferences->prefrences);
            $posts = BlogPost::whereIn('ginopane_blogtaxonomy_series_id',$prefrences)->with(['categories', 'featured_images'])->listFrontEnd([
