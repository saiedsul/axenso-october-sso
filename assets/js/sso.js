...
/***/ "./sources/js/helpers/form_validate.js":
/*!*********************************************!*\
  !*** ./sources/js/helpers/form_validate.js ***!
  \*********************************************/
/***/ (() => {
...
/***/ "./sources/js/helpers/reg_form_validate.js":
/*!*************************************************!*\
  !*** ./sources/js/helpers/reg_form_validate.js ***!
  \*************************************************/
/***/ (() => {
...
$(document).ready(function () {
  ...
  $('.btnPrevious').click(function () {
    var prevTabLinkEl = $('.nav-tabs .active').closest('li').prev('li').find('a')[0];
  ...
  $("#regForm").validate({
    rules: {
      ...
      specialization: _defineProperty({
        required: true,
        notEqualTo: function notEqualTo() {
          return $('select[name="specialization_2"]').val();
        }
      }, "notEqualTo", function notEqualTo() {
        return $('select[name="specialization_3"]').val();
      }),
      sub_specialization: {
        required: true
      },
      specialization_2: {
        notEqualTo: function notEqualTo() {
          return $('select[name="specialization"]').val();
        }
      },
      specialization_3: {
        notEqualTo: function notEqualTo() {
...
/***/ "./sources/js/helpers/sidebar-collapse.js":
/*!************************************************!*\
  !*** ./sources/js/helpers/sidebar-collapse.js ***!
  \************************************************/
/***/ (() => {
...
$(function () {
  ...
  __webpack_require__(/*! ./helpers/sidebar-collapse */ "./sources/js/helpers/sidebar-collapse.js");
  __webpack_require__(/*! ./helpers/tooltip */ "./sources/js/helpers/tooltip.js");
  __webpack_require__(/*! ./helpers/reg_form_validate */ "./sources/js/helpers/reg_form_validate.js");
  __webpack_require__(/*! ./helpers/form_validate */ "./sources/js/helpers/form_validate.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkaxe_sso_asst"] = self["webpackChunkaxe_sso_asst"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/sso"], () => (__webpack_require__("./sources/js/sso.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/sso"], () => (__webpack_require__("./sources/scss/sso.scss")))
